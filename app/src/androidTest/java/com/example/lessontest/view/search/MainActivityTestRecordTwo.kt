...
class MainActivityTestRecordTwo {
    ...
    fun mainActivityTestRecordTwo() {
        ...
        val textView = onView(
            allOf(withId(R.id.totalCountTextViewDet), withText("Number of results: -1"),
        ...
        val textView2 = onView(
            allOf(withId(R.id.totalCountTextViewDet), withText("Number of results: 0"),
                withParent(withParent(withId(android.R.id.content))),
                isDisplayed()))
